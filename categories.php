							...
							<?php
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo htmlspecialchars($row['name']) ?>" data-description="<?php echo htmlspecialchars($row['description']) ?>">Edit</button>
